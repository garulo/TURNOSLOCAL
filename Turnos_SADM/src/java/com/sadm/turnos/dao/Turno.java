...
public class Turno {
    ...
    private String strIdUserAttending;
    private String strUserAttending;
    private String strEstatusAtencion;    
    private String valPreferencial;
    ...
    public void setStrTipoServicio(String strTipoServicio) {
        this.strTipoServicio = strTipoServicio;
    }
    
    

    public String getStrIdUserAttending() {
        return strIdUserAttending;
    }

    public void setStrIdUserAttending(String strIdUserAttending) {
        this.strIdUserAttending = strIdUserAttending;
    }

    public String getStrUserAttending() {
        return strUserAttending;
    }

    public void setStrUserAttending(String strUserAttending) {
        this.strUserAttending = strUserAttending;
    }

    public String getStrEstatusAtencion() {
        return strEstatusAtencion;
    }

    public void setStrEstatusAtencion(String strEstatusAtencion) {
        this.strEstatusAtencion = strEstatusAtencion;
    }

    
    public String getValPreferencial() {
        return valPreferencial;
    }

    public void setValPreferencial(String valPreferencial) {
        this.valPreferencial = valPreferencial;
    }
